...
@Component({
  selector: 'app-calc-invierte',
  templateUrl: './calc-invierte.component.html',
  styleUrls: ['./calc-invierte.component.scss']
})
export class CalcInvierteComponent implements OnInit {
