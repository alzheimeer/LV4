...
@Component({
  selector: 'app-calc-hipoteca',
  templateUrl: './calc-hipoteca.component.html',
  styleUrls: ['./calc-hipoteca.component.scss']
})
export class CalcHipotecaComponent implements OnInit {
