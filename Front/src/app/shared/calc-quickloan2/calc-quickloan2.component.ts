...
@Component({
  selector: 'app-calc-quickloan2',
  templateUrl: './calc-quickloan2.component.html',
  styleUrls: ['./calc-quickloan2.component.scss']
})
export class CalcQuickloan2Component implements OnInit {
