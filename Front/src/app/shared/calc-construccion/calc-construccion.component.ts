...
@Component({
  selector: 'app-calc-construccion',
  templateUrl: './calc-construccion.component.html',
  styleUrls: ['./calc-construccion.component.scss']
})
export class CalcConstruccionComponent implements OnInit {

  @Output()
  value = new EventEmitter<number>();

  valor: number = 2000000;
  meses: number = 1;
  tasa: number = 1.8778;
